...
const EditEventDialog = ({ isOpen, onClose, onEditEvent, event, ministries, onAddMinistry }: EditEventDialogProps) => {
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="space-y-2">
            ...
            <Textarea
              ...
              className="min-h-[100px] border-2 border-gray-200 focus:border-blue-500 resize-none"
            />
          </div>
